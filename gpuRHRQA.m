...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [IdxM, HRR, HMean, HVar, HSkew, HKurt, HEnt, HGini] = gpuRHRQA(s, K, r, a, B)
    if isempty(s)
    ...
    if(r == 0)
        ...
        UC_Res = gpuArray(NaN(length(UC),7)); 
        for i = 1:size(UC,1)
    ...
    %         LC_D = pdist(LC_ifs);
        ...
        M_Res = gpuArray(NaN(size(IdxM,1),7));
        for i = 1:length(UC)
